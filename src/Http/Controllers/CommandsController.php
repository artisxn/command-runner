...
class CommandsController
{
    ...
    {
        return config('command-runner.commands');
    }

    public function run($index)
    {
        $commands = config('command-runner.commands');
        ...
        if ($historyLength = config('command-runner.history')) {
            ...
            \Cache::forever('command-runner-history', $history);
        }
